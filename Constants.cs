namespace SecondBot.Client {
    ...
    {
        public const string COMMANDS = "マニュアル,座 uuid,休,立ち,おいで,止,テレポ sim/x/y/z,終了,グループ groupname,帰/戻,チャットモード 指名or全レス,チャットAPI chatplus or mebo,どこ,タッチ uuid,ランダム発言 ON/OFF,アニメリスト,アニメ アニメ名,踊";
